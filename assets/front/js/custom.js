...
var THcSlider = new Swiper('.THcSlider', {
    loop: true,
    autoplay: true,
    slidesPerView: 5,
    spaceBetween: 10,
...
let productSlider = new Swiper('.productSlider-for', {
    loop: true,
    slidesPerView: 1,
    spaceBetween: 20,
    breakpoints: {
...
let productNav = new Swiper('.productSlider-nav', {
    loop: true,
    slidesPerView: 4,
    spaceBetween: 20,
...
productNav.controller.control = productSlider;
productSlider.controller.control = productNav;
...
function heartActive() {
    let heart = document.querySelectorAll('i.fas.fa-heart');
    console.log('working')
    heart.forEach((heart) => {
