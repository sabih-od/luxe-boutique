            ...
            foreach ($cart->items as $prod) {
                ...
                if ($x != null) {
                    ...
                    if ($product->stock == 1) {
                        ...
                        $to = $vendor->email;
                        $from = 'noreply@imausa.com';
                        $subject = "Product Stock";
                        $msg = 'Hi ' . $vendor->name . "</br>";
                        $msg .= "Your product " . $product->name . " is running out of stock. You only have 1 product left in stock please restock your inventory to keep selling the product.<br>";
                        $msg .= "Regards<br>";
                        $msg .= "Team IMA USA";


                        self::customMail($from, $to, $subject, $msg);
                    }
                    if ($product->stock == 0) {
                        $vendor = User::where('id', $product->user_id)->first();
                        $to = $vendor->email;
                        ...
                        $msg = 'Hi ' . $vendor->name . "</br>";
                        $msg .= "Your product " . $product->name . "  is out of stock. Please restock your inventory to keep selling the product.<br>";
                        $msg .= "Regards<br>";
                        $msg .= "Team IMA USA";
