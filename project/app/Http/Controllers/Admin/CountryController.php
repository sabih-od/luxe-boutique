...
class CountryController extends Controller
{
    ...
    public function datatables()
    {
        ...
        return DataTables::of($datas)
            ...
            ->addColumn('flag', function (Country $data) {
                $class = $data->flag == 1 ? 'drop-success' : 'drop-danger';
                $s = $data->flag == 1 ? 'selected' : '';
                $ns = $data->flag == 0 ? 'selected' : '';
    ...
    {
        $datas = Country::where('flag', 1)->orderBy('id', 'desc');
        //--- Integrating This Collection Into Datatables
        return DataTables::of($datas)
            ->addColumn('action', function (Country $data) {
