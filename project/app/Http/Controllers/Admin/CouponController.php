...
class CouponController extends AdminBaseController
{
    ...
    public function create()
    {
        ...
        return view('admin.coupon.create',compact('categories','sub_categories','child_categories','subscription'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->pkg_type = $request->pkg_type;
...
//          $data->load($subscription);
          return view('admin.coupon.edit',compact('data','categories','sub_categories','child_categories','subscription'));
      }
    ...
    public function destroy($id)
    {
        ...
        //    Start Package Coupon Setting

    //*** JSON Request
    public function pkgcdatatables()
    {
        $datas = Coupon::latest('id')->get();
        //--- Integrating This Collection Into Datatables
        return Datatables::of($datas)
    ...
    //*** POST Request
    public function pkgupdate(Request $request, $id)
    {
        //--- Validation Section
    ...
    //*** GET Request Status
    public function pkgstatus($id1,$id2)
    {
        $data = Coupon::findOrFail($id1);
        $data->status = $id2;
        $data->update();
