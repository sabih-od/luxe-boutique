...
class SubscriptionController extends AdminBaseController
{
    ...
    public function datatables()
    {
        ...
        return Datatables::of($datas)
            ...
            ->editColumn('total_price', function (Subscription $data) {
                $total_price = $data->total_price == 0 ? '0' : $data->total_price;
                return \PriceHelper::showAdminCurrencyPrice($total_price);
            })
            ->editColumn('payout_time', function (Subscription $data) {
                $payout_time = $data->payout_time == null ? '0' : $data->payout_time;
                return $payout_time;
            })
    ...
    public function store(Request $request)
    {
        ...
        $input['payout_time'] = $request['payout_time'];
