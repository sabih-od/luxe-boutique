...
use App\{Models\Cart, Models\Product};
...
class CartController extends FrontBaseController
{
    ...
    public function cart(Request $request)
    {
        ...
        if (!Session::has('cart')) {
            switch ($gs->active_theme){
                case('1'):
                    ...
                    break;
                case('2'):
                    return view('frontend.theme-2.cart');
                    break;
                case('4'):
                    return view('frontend.theme-4.cart');
                    break;
            }
        ...
        switch ($gs->active_theme) {
            case('1'):
                ...
                break;
            case('2'):
                return view('frontend.theme-2.cart', compact('products', 'totalPrice', 'mainTotal'));
                break;
            case('4'):
                return view('frontend.theme-4.cart', compact('products', 'totalPrice', 'mainTotal'));
                break;
        }
    ...
    {
        $prod = Product::where('id', '=', $id)->first(['id', 'user_id', 'slug', 'name', 'photo', 'size', 'size_qty', 'size_price', 'color', 'price', 'stock', 'type', 'file', 'link', 'license', 'license_qty', 'measure', 'whole_sell_qty', 'whole_sell_discount', 'attributes', 'minimum_qty', 'size_all', 'color_all', 'is_printify', 'printify_product_id', 'printify_variant_id']);
        // Set Attrubutes
...
//            dd($data);
    ...
    public function addnumcart(Request $request)
    {
        ...
        $prod = Product::where('id', '=', $id)->first(['id', 'user_id', 'slug', 'name', 'photo', 'size', 'size_qty', 'size_price', 'color', 'price', 'stock', 'type', 'file', 'link', 'license', 'license_qty', 'measure', 'whole_sell_qty', 'whole_sell_discount', 'attributes', 'minimum_qty', 'stock_check', 'size_all', 'color_all', 'is_printify', 'printify_product_id', 'printify_variant_id']);
