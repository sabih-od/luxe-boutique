            ...
            if ($response != null) {
                ...
                if ($response->getMessages()->getResultCode() == "Ok") {
                    ...
                    if ($order->user_id != 0 && $order->wallet_price != 0) {
                        ...
                        $view = view('frontend.mail2.order_customer_email', compact('customer_name','onumber','type'))->render();
...
//                        'onumber' => $order->order_number,
                    ...
                    //Sending Email To Admin
                       $orders= $order->order_number;
                        $view = view('frontend.mail2.order_customer_sent_to_admin_email', compact('orders'))->render();
