            ...
            if ($resp['status'] = "success") {
                if(!empty($resp['data'])){
                    ...
                    if ($order->user_id != 0 && $order->wallet_price != 0) {
                        ...
                        $type = "new_order";
                        $view = view('frontend.mail2.fluterwav_order_customer_email', compact('customer_name','onumber','type'))->render();
...
//                        'onumber' => $order->order_number,
                    ...
                    //Sending Email To Admin
                        ...
                        $view = view('frontend.mail2.fluterwav_order_customer_sent_to_admin_email', compact('orders'))->render();
                    $data = [
