...
class MercadopagoController extends CheckoutBaseControlller
{
    public function store(Request $request)
    {
        ...
        if ($payment->status == 'approved') {
            ...
            $type = "new_order";
            $view = view('frontend.mail2.mercadopago_order_customer_email', compact('customer_name','onumber','type'))->render();
...
//                'onumber' => $order->order_number,
            ...
            $view = view('frontend.mail2.mercadopago_order_customer_sent_to_admin_email', compact('orders'))->render();
            $data = [
