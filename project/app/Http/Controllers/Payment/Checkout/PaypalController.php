...
class PaypalController extends CheckoutBaseControlller
{
    ...
    public function notify(Request $request)
    {
        ...
        if ($result->getState() == 'approved') {
            ...
            $view = view('frontend.mail2.paypal_order_customer_email', compact('customer_name','onumber'))->render();
            $data_user = [
...
//                'body' => "Hello ".$order->customer_name."<br>Thank you for placing an order.<br>Order Number is " . $order->order_number,
            ...
            $view = view('frontend.mail2.paypal_order_customer_sent_to_admin_email', compact('orders'))->render();
