    ...
    public function notify(Request $request)
    {
        ...
        if ($input_data['STATUS'] == 'TXN_SUCCESS') {
            ...
            if($payment_id == $input_data['ORDERID']){
                ...
                $type = "new_order";
                $view = view('frontend.mail2.paytm_order_customer_email', compact('customer_name','onumber','type'))->render();
...
//                    'onumber' => $order->order_number,
                ...
                $view = view('frontend.mail2.paytm_order_customer_sent_to_admin_email', compact('orders'))->render();
