...
class RazorpayController extends CheckoutBaseControlller
{
    ...
    public function notify(Request $request)
    {
        ...
        if ($success === true){
            ...
            $type = "new_order";
            $view = view('frontend.mail2.razorpay_order_customer_email', compact('customer_name','onumber','type'))->render();
...
//                    'onumber' => $order->order_number,
            ...
            $view = view('frontend.mail2.razorpay_order_customer_sent_to_admin_email', compact('orders'))->render();
