...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'issubscriptionexipre' => \App\Http\Middleware\IsSubscriptionExpire::class,
        ...
        'restrict.front' => \App\Http\Middleware\Authenticate::class,
        'user.booking' => \App\Http\Middleware\UserBooking::class,
