...
class Product extends Model
{
    ...
    protected $fillable = ['user_id', 'category_id', 'product_type', 'affiliate_link', 'sku', 'subcategory_id', 'childcategory_id', 'attributes', 'name', 'photo', 'size', 'size_qty', 'size_price', 'color', 'printify_variant_id', 'details', 'price', 'previous_price', 'stock', 'policy', 'status', 'views', 'tags', 'featured', 'best', 'top', 'hot', 'latest', 'big', 'trending', 'sale', 'features', 'colors', 'product_brand', 'product_condition', 'ship', 'meta_tag', 'meta_description', 'youtube', 'type', 'file', 'license', 'license_qty', 'link', 'platform', 'region', 'licence_type', 'measure', 'discount_date', 'is_discount', 'whole_sell_qty', 'whole_sell_discount', 'catalog_id', 'slug', 'language_id', 'flash_count', 'hot_count', 'new_count', 'sale_count', 'best_seller_count', 'popular_count', 'top_rated_count', 'big_save_count', 'trending_count', 'page_count', 'seller_product_count', 'wishlist_count', 'vendor_page_count', 'min_price', 'max_price', 'product_page', 'post_count', 'minimum_qty', 'preordered', 'language_id', 'color_all', 'size_all', 'stock_check', 'phone', 'address', 'age', 'is_printify', 'printify_product_id', 'printify_product_update_date', 'deal','sale_start_date','sale_end_date'];

    public $selectable = ['id', 'user_id', 'name', 'slug', 'features', 'colors', 'printify_variant_id', 'thumbnail', 'price', 'previous_price', 'attributes', 'size', 'size_price', 'discount_date', 'color_all', 'size_all', 'stock_check', 'category_id', 'details', 'is_printify', 'printify_product_id', 'printify_product_update_date', 'latest', 'language_id', 'deal','sale_start_date','sale_end_date'];
...
//        dd($this->previous_price);

//        dd((($this->previous_price - $this->price) / $this->previous_price) * 100);
//        dd($this->price);
//        return ($this->previous_price - (($this->price) / $this->previous_price)) ? $this->price : 1 * 100;
//        return ($this->previous_price) / ((!empty($this->price)) ? $this->price : 1 * 100);
