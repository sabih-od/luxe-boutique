                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusformdata" action="{{ route('admin-order-refund-edit',$data->id) }}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="email" class="input-field" name="email" placeholder="{{ __("Email Address") }}" value="{{ $data->customer_email }}">
                                    </div>
                                </div>
...
{{--                                    </div>--}}
{{--                                    <div class="col-lg-7">--}}
{{--                                        <input type="text" class="input-field" name="shop_address" placeholder="{{ __("Shop Address") }}"  value="{{ $data->shop_address }}">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
