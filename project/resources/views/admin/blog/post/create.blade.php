...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add New Post') }} <a class="add-btn"
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{route('admin-blog-create')}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="source"
                                               placeholder="{{ __('Source') }}" required=""
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="text-editor">
                                                <textarea class="input-field" name="meta_description"
