...
@section('content')
<input type="hidden" id="headerdata" value="{{strtoupper($country->name)}} / {{ __('STATE TAX') }}">
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading"><u>{{ __($country->name) }}</u> / {{ __('Tax') }} <a class="add-btn" href="{{route('admin-country-tax')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" readonly class="input-field"  value="{{$country->name}}">
                        </div>
                      </div>
                      ...
                      <div class="show_state d-none">
                        <hr>
                        <u><h4 class="text-center mb-3">{{$country->name}} / {{__('State List')}}</h4></u>
                        <br>
