                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-coupon-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="code" placeholder="{{ __('Enter Code') }}">
                          </div>
                        </div>

                        <div class="row" id="Allow_Product">
                          <div class="col-lg-4">
                            <div class="left-area">
                          ...
                          <div class="row" id="pkg_type">
                              <div class="col-lg-4">
                                  <div class="left-area">
                                      <h4 class="heading">{{ __('Allow Package Type') }}*</h4>
                                  </div>
                              </div>
                              <div class="col-lg-7">
                                  <select  name="pkg_type" id="click_select">
                                      <option value="">{{ __('Select Package') }}</option>
                                      @foreach($subscription as $subsription_pkg_type)
                                          <option value="{{$subsription_pkg_type->id }}">{{$subsription_pkg_type->title }}</option>
                                      @endforeach
                                  </select>
                              </div>
                          </div>
...
<script>
    $(document).on('change', '#click_select', function() {

        $('#Allow_Product').addClass('d-none');
