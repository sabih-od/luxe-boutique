                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-coupon-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="code" placeholder="{{ __('Enter Code') }}" value="{{$data->code}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          @if(isset($data->subscription_pkg->id))
                          <div class="row" id="pkg_type">
                              ...
                              <div class="col-lg-7">
                                  <select  name="pkg_type" id="click_select">
                                      <option value="{{$data->subscription_pkg->id}}"> {{$data->subscription_pkg->title}}</option>
