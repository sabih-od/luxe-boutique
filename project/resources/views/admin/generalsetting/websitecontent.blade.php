                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="tawk-area">
                                        <input type="text" class="input-field" name="zip_code" value="{{$gs->zip_code}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="tawk-area">
                                        <input type="number" class="input-field" step="0.01" name="shipping_rate" value="{{$gs->shipping_rate}}">
                                    </div>
                                </div>
                            </div>
