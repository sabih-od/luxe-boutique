                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ $gs->active_theme == 2 ? __('Child Category') : __('Child Category') }}
                                                        *</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <select id="childcat" name="childcategory_id" disabled="">
                                                    <option
                                                        value="">{{ $gs->active_theme == 2 ? __('Select Child Category') : __('Select Child Category') }}</option>
                                                </select>
                                            </div>
                                        </div>
