                                                ...
                                                <ul class="list">
                                                    <li>
                                                        ...
                                                        <label for="size-check"
                                                               class="stock-text">{{ __('Manage Stock Variation') }}</label>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __('Sale Start Date') }}*</h4>
                                                    <p class="sub-heading">{{ __('(Optional)') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="sale_start_date" step="0.01" type="date"
                                                       class="input-field" placeholder="e.g 20"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __('Sale End Date') }}*</h4>
                                                    <p class="sub-heading">{{ __('(Optional)') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="sale_end_date" step="0.01" type="date"
                                                       class="input-field" placeholder="e.g 20"
