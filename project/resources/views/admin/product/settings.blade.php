                        ...
                        <div class="body-area">
                            ...
                            <form action="{{ route('admin-gs-prod-settings-update') }}" id="geniusform" method="POST"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" class="input-field"
                                               placeholder="{{ __('Product Whole Sale Max Quantity') }}"
                                               name="wholesell"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" class="input-field"
                                               placeholder="{{ __('Display Sale Products') }}"
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" class="input-field"
                                               placeholder="{{ __('Display Top Rated Products') }}"
