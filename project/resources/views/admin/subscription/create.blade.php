                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="title"
                                               placeholder="{{ __("Enter Subscription Title") }}" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="price"
                                               placeholder="{{ __("Enter Subscription Cost") }}" required="" value="">
                                    </div>
                                </div>
...
{{--                                               placeholder="{{ __("Enter Subscription Days") }}" required="" value="">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="number" min="1" class="input-field" id="allowed_products"
                                                   ...
                                                   placeholder="{{ __("Enter Allowed Products") }}" value="1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="total_price"
                                               placeholder="{{ __("Enter Total Price") }}" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="payout_time"
                                               placeholder="{{ __("Enter Payout Time") }}" required="" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <button class="addProductSubmit-btn"
                                                type="submit">{{ __("Create Plan") }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
