                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="title"
                                               placeholder="{{ __("Enter Subscription Title") }}" required=""
                                               value="{{ $data->title }}">
                                    </div>
                                </div>
...
{{--                                </div>--}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <select id="limit" name="limit" required="">
                                            ...
                                            <option
                                                {{ $data->allowed_products == 0 ? "selected" : "" }} value="0">{{ __("Unlimited") }}</option>
                                            <option
                                                {{ $data->allowed_products != 0 ? "selected" : "" }} value="1">{{ __("Limited") }}</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="number" min="1" class="input-field" id="allowed_products"
                                                   ...
                                                   placeholder="{{ __("Enter Allowed Products") }}"
                                                   {{ $data->allowed_products != 0 ? "required" : "" }} value="{{ $data->allowed_products != 0 ? $data->allowed_products : '1' }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="total_price"
                                               placeholder="{{ __("Enter Total Price") }}" required=""
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="payout_time"
                                               placeholder="{{ __("Enter Payout Time") }}" required=""
                                               value="{{ $data->payout_time }}">
                                    </div>
                                </div>
