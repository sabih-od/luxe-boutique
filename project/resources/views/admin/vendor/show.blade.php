                                ...
                                <div class="col-md-4">
                                    <div class="table-responsive show-table">
                                        <table class="table">
                                            ...
                                            @if( $data->user_id  == 0)
                                                <tr>
                                                    <th>{{ __('Vendor Dashboard') }}</th>
                                                    <td class="cnt-sell">
                                                        <a href="{{ route('front.vendor', $data->shop_name) }}"
                                                           class="view-stor btn--base text-dark">
                                    ...
                                    <div class="table-responsive show-table">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($data->checkStatus())
                                                        <a class="badge badge-success verify-link" href="javascript:;"
                                                           id="verifyLink">Verified</a>
                                                    ...
                                                    @else
                                                        <a class="badge badge-danger verify-link" id="verifyLink"
                                                           href="javascript:;">Unverified</a>
                                                    @endif
                                                </td>
