            ...
            @if(Session::has('cart'))
                <div class="col-xl-8 col-lg-12 col-md-12 col-12">
                    <div class="cart-table">
                        <div class="gocover"
                             style="position: absolute; background: url({{ asset('assets/images/xloading.gif') }}) center center no-repeat scroll rgba(255, 255, 255, 0.5); display: none;"></div>
                                ...
                                <tr class="woocommerce-cart-form__cart-item cart_item">
                                    <td class="product-thumbnail">
                                        <a href="{{ route('front.product', $product['item']['slug']) }}">
                                            <img
                                                src="{{ str_contains($product['item']['photo'], 'https://images-api.printify.com') ? $product['item']['photo'] :
                                ...
                                <span>{{ App\Models\Product::convertPrice($product['item_price']) }}
                                    ...
                                    <td class="product-remove">
                                        <a href="#" class="remove cart-remove"
                                           ...
                                           data-href="{{ route('product.cart.remove',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'-',$product['values'])) }}">×</a>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
                        ...
                        <div class="cart_totals ">
                            ...
                            <table>
                                ...
                                <tr class="order-total">
                                    <th>Total</th>
                                    <td><strong><span
                                                class="woocommerce-Price-amount amount main-total">{{ Session::has('cart') ? App\Models\Product::convertPrice($mainTotal) : '0.00' }}</span></strong>
                                    </td>
                                </tr>
                            </table>
