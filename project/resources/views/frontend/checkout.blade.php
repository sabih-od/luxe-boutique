            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form id="" action="" method="POST" class="checkoutform">
                                    ...
                                    <div class="content-box">
                                        <div class="content">
                                            <div class="submit-loader" style="display: none;">
                                                <img
                                                    src="//geniusocean.com/demo/geniuscart/default/assets/images/loading_large.gif"
                                                    alt="">
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 mb-2 d-none" id="shipshow">
                                                        <select class="form-control" name="pickup_location">
                                                            @foreach($pickups as $pickup)
                                                                <option
                                                                    value="{{$pickup->location}}">{{$pickup->location}}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    @else
                                                        <div class="col-lg-6 select_state">
                                                            <select class="form-control validate" id="show_state"
                                                                    name="customer_state">
                                                    ...
                                                    @if(Auth::check())
                                                        <div class="col-lg-6">
                                                            <input class="form-control validate mt-2" type="text"
                                                                   name="customer_city"
                                                                   placeholder="{{ __('City') }}" required=""
                                                                   value="{{ Auth::user()->city ?? '' }}">
                                                        </div>
                                                    @else
                                                        <div class="col-lg-6 select_city mt-2">
                                                            <select class="form-control validate" id="show_city"
                                                                    name="customer_city">
                                                ...
                                                @foreach($products as $key => $product)
                                                    <div class="order-item">
                                                        <div class="product-img">
                                                            <div class="d-flex">
                                                                <img src="{{ str_contains($product['item']['photo'], 'https://images-api.printify.com') ? $product['item']['photo'] :
                                    ...
                                    <div class="content-box">
                                        <div class="content">
                                            ...
                                            <div class="payment-information">
                                                <h4 class="title">
                                                    {{ __('Payment Info') }}
                                                    <img src="{{asset('assets/images/CC-Logo.png')}}" height="50px">
                                                </h4>
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="nav flex-column" role="tablist"
                                                            ...
                                                            @foreach($gateways as $gt)
                                                                @if($gt->type == 'manual')
                                                                    ...
                                                                    @endif
                                                                @else
                                                                    @if($gt->name == 'Stripe' or $gt->name == 'Paypal')
                                                                        <a class="nav-link payment"
                                                                           data-val="{{ $gt->keyword }}"
                                                                           data-show="{{$gt->showFormForCheckout()}}"
                                                                           data-form="{{ $gt->showCheckoutLink() }}"
                                                                           data-href="{{ route('front.load.payment',['slug1' => $gt->showKeyword(),'slug2' => $gt->id]) }}"
                                                                           id="v-pills-tab{{ $gt->id }}-tab"
                                                                           data-toggle="pill"
                                                            ...
                                                            <div class="tab-content" id="v-pills-tabContent">
                                                                @foreach($gateways as $gt)
                                                                    @if($gt->type == 'manual')
                                                                        ...
                                                                        @endif
                                                                    @else
                                                                        <div id="googlePayButton" class="d-none"></div>
                                                                        <div class="tab-pane fade"
                                                                             id="v-pills-tab{{ $gt->id }}"
                                                                             role="tabpanel"
                                                                             aria-labelledby="v-pills-tab{{ $gt->id }}-tab">
                        ...
                        <input type="hidden" id="shipping-cost" name="shipping_cost" value="{{ $shipping_cost }}">
                        ...
                        <input type="hidden" name="total" value="{{ $totalPrice + $shipping_cost }}" id="total_amount">
                        <input type="hidden" name="weight" value="{{ $weight }}" id="weight">
                        <input type="hidden" name="shipping_rate" value="" id="shipping_rate">
                    ...
                    <div class="col-lg-4">
                        <div class="right-area">
                            <div class="order-box">
                                ...
                                @if($digital == 0)
                                    {{-- Shipping Services Area End --}}
                                    {{-- Shipping Method Area Start --}}
                                    <div class="packeging-area">
                                        <h4 class="title">{{ __('Shipping Services') }}</h4>
                                        @if(count($shippingServices) > 0)
                                            @foreach($shippingServices as $shippingService)
                                                <div class="radio-design">
                                                    <input type="radio" class="shipping"
                                                           data-form="{{ strtolower($shippingService->service_name) }}"
                                                           id="free-shepping{{ $shippingService->id }}"
                                                           name="shipping"
                                                           value="0">
                                                    <span class="checkmark"></span>
                                                    <label
                                                        for="free-shepping{{ $shippingService->id }}">{{ $shippingService->service_name }}</label>
                                                </div>
                                            @endforeach
                                            <button></button>
                                        ...
                                        @else
                                            @foreach($shipping_data as $data)
                                                <div class="radio-design">
                                                    <input type="radio" class="shipping" data-form="{{$data->title}}"
                                    ...
                                    <div class="packeging-area">
                                        ...
                                        @foreach($package_data as $data)
                                            <div class="radio-design">
                                                <input type="radio" class="packing" data-form="{{$data->title}}"
                                    ...
                                    @if(Session::has('coupon_total'))
                                        ...
                                        @else
                                            <span
{{--                                                @dd(App\Models\Product::convertPrice($totalPrice));--}}
                                            ...
                                            <form id="wallet-form">
                                                @if(Session::has('coupon_total'))
                                                    <input type="number" class="form-control border"
                                                           placeholder="{{ __("Enter Your Amount") }}" step="0.01"
                                                           id="wallet-amount" min="1" required=""
                                                           value="{{ $totalPrice <= ( Auth::user()->balance * $curr->value ) ? $totalPrice :  round(Auth::user()->balance * $curr->value ,2) }}">
                                                @elseif(Session::has('coupon_total1'))
                                                    <input type="number" class="form-control border"
                                                           placeholder="{{ __("Enter Your Amount") }}" step="0.01"
                                                           id="wallet-amount" min="1" required=""
                                                           value="{{ preg_replace("/[^0-9,.]/", "", Session::get('coupon_total1')) <= ( Auth::user()->balance * $curr->value ) ? preg_replace("/[^0-9,.]/", "", Session::get('coupon_total1')) :  round(Auth::user()->balance * $curr->value ,2) }}">
                                                @else
                                                    <input type="number" class="form-control border"
                                                           placeholder="{{ __("Enter Your Amount") }}" step="0.01"
                                                           id="wallet-amount" min="1" required=""
                                                           value="{{ round($totalPrice * $curr->value,2) <= ( Auth::user()->balance * $curr->value ) ? round($totalPrice * $curr->value,2) :  round(Auth::user()->balance * $curr->value ,2) }}">
                                                @endif
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        if (pos == 0) {
            $('#final-cost').html(curr + ftotal)
        } else {
            // $('#final-cost').html(ftotal + curr )
        ...
        $(document).on('change', '#show_state', function () {
            ...
            var id = state_id,
                state_url = "{{ route('country.wise.city', ':id') }}";
            state_url = state_url.replace(':id', id);
            $.get(state_url, function (response) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (pos == 0) {
                        ...
                        $('#final-cost').html(curr + tttotal);
                        $('.total-cost-dum #total-cost').html(curr + ttotal);
                    } else {

                        $('#total-cost').html('');
                        $('#final-cost').html(curr + tttotal);

                        // $('#final-cost').html(tttotal + curr);
                        $('.total-cost-dum #total-cost').html(curr + ttotal);

                        // $('.total-cost-dum #total-cost').html(ttotal + curr);
                    }
                    $('.gocover').hide();
                }
            });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 0) {
                        ...
                        if (pos == 0) {
                            $('#wallet-cost').html(curr + (data[1] + wallet_price));
                            $('#final-cost').html(curr + data[0].toFixed(2));
                        } else {
                            $('#wallet-cost').html((data[1] + wallet_price) + curr);
                            $('#final-cost').html(data[0].toFixed(2) + curr);
                        }
        ...
        $('.shipping').on('click', function () {
            if ($(this).data('form') == 'usps' || $(this).data('form') == 'ups') {
                getUspsShippingRate();
            } else {
                mship = $(this).val();
                $('#shipping-cost').val(mship);
                ...
                ttotal = parseFloat(ttotal).toFixed(2);
                if (pos == 0) {
                    $('#final-cost').html(curr + ttotal);
                } else {
                    $('#final-cost').html(curr + ttotal)
                    // $('#final-cost').html(ttotal + curr);
                }
        ...
        $('.packing').on('click', function () {
            $('[name="selected_package_id"]').val($(this).data('id'));
            mpack = $(this).val();
            $('#packing-cost').val(mpack);
            var ttotal = parseFloat($('#tgrandtotal').val()) + parseFloat(mship) + parseFloat(mpack) + parseFloat($('[name="shipping_rate[]"] option:selected').val() ?? 0);
            ttotal = parseFloat(ttotal).toFixed(2);
            ;
            ...
            $('#grandtotal').val(ttotal);
            $('#shipping_rate').val($('[name="shipping_rate[]"] option:selected').val());
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 0) {
                        ...
                        if (pos == 0) {
                            $('.total-cost-dum #total-cost').html(curr + data[0]);
                            $('#discount').html(curr + data[2]);
                        } else {
                            $('.total-cost-dum #total-cost').html(data[0] + curr);
                            $('#discount').html(data[2] + curr);
                        }
                        $('#grandtotal').val(data[0]);
                        $('#tgrandtotal').val(data[0]);
    ...
    <script>
        ...
        const tokenizationSpecification = {
            ...
            parameters: {
                'gateway': 'example',
                'gatewayMerchantId': 'BCR2DN4T2T2LDED4'
            }
        };
        ...
        function getGooglePaymentDataRequest() {
            ...
            paymentDataRequest.merchantInfo = {
                ...
                merchantId: 'BCR2DN4T2T2LDED4',
                merchantName: 'IMA USA SHOP'
            };
    ...
    <script>
        function getUspsShippingRate() {
            let first_name = $('[name="personal_name"]').val();
            let last_name = $('[name="last_name"]').val();
            let email = $('[name="personal_email"]').val();
            let phone = $('[name="customer_phone"]').val();
            let address = $('[name="customer_address"]').val();
            let country = $('[name="customer_country"]').val();
            let city = $('[name="customer_city"]').val();
            let zip_code = $('[name="customer_zip"]').val();
            let state = $('[name="customer_state"]').val();
            let subtotal = $('#total_amount').val();
            let weight = $('#weight').val();

            if (address === null | city === null | state === null | zip_code === null) {
                $('.shipping').prop('checked', false);
                $('.validate').addClass('is-invalid');
                return toastr.error('Make sure to fill the required field properly.');
            }

            $('.paystack-area-btn button.mybtn1').attr('disabled', true).text('Processing...');

            $.ajax({
                'url': "{{ route('calculate.usps.shipping') }}",
                data: {
                    subtotal: subtotal,
                ...
                success: function (res) {
                    if (typeof res.Error !== 'undefined') {
                        $('.shipping').prop('checked', false);
                        return toastr.error(res.Error.Description);
                    } else {
                        //toastr.success(res);
                        const obj = JSON.parse(res);
                        var html = '<select name="shipping_rate[]" class="form-control"><option>Select</option>';
                        $.each(obj, function (i, o) {
                            html += '<option value="' + o.value + '">' + o.name + ' | $' + o.value + '</option>'
                        });
                        html += '</select>'

                        $('#shippingRates').empty().append(html)
                        var shipping_options = $('#shippingRates').find('select').find('option');
                        shipping_options.each(function () {
                            if (($(this).val() != '66.35' && $(this).val() != '22.45' && !$(this).text().includes('Large Flat Rate Box |') && !$(this).text().includes('USPS Retail Ground')) || $(this).text().includes('Pickup')) {
                                $(this).remove();
                            }
                        });
                        $('#final-cost').html(parseFloat($('#grandtotal').val()) + parseFloat(22.45));
                        $('#shipping_rate').val(22.45);
                        $('#shippingMethods').removeClass('d-none');
                    }
                    $('.paystack-area-btn button.mybtn1').attr('disabled', false).text('Continue');
                }
            })
        }

        $(document).on('change', '[name="shipping_rate[]"]', function () {
            mship = $(this).val();
            $('#shipping-cost').val(mship);
            var ttotal = parseFloat($('#tgrandtotal').val()) + parseFloat(mship) + parseFloat(mpack);
            ttotal = parseFloat(ttotal).toFixed(2);
