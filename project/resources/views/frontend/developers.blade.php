...
@section('content')
    ...
    <div class="full-row bg-light overlay-dark py-5"
        ...
        <div class="container">
            <div class="row text-center text-white">
                <div class="col-12">
                    <h3 class="mb-2 text-white">{{ __('Developers') }}</h3>
                </div>
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 d-inline-flex bg-transparent p-0">
                            <li class="breadcrumb-item"><a href="{{ route('front.index') }}">{{ __('Home') }}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Developers') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    {{--                    <p><a href="{{ route('front.developers') }}" class="text-dark">https://imausashop.com/</a> is committed to excellence--}}
    {{--                        and the full--}}
    {{--                        satisfaction of our customers. <a--}}
    {{--                            href="{{ route('front.developers') }}" class="text-dark">https://imausashop.com/</a> proudly offers--}}
    ...
    {{--                        <a href="{{ route('front.developers') }}" class="text-dark">https://imausashop.com/</a> also offers same-day--}}
    {{--                        dispatch.</p>--}}
    ...
    {{--                    <p>4. LOST/STOLEN PACKAGES <a href="{{ route('front.developers') }}" class="text-dark">https://imausashop.com/</a> is--}}
    {{--                        not responsible for--}}
    ...
    {{--                    <p>5. RETURN REQUEST DAYS <a href="{{ route('front.developers') }}" class="text-dark">https://imausashop.com/</a>--}}
    ...
    {{--                    <p>6. OUT OF STOCK ITEM PROCESS <a--}}
    {{--                            href="{{ route('front.developers') }}" class="text-dark">https://imausashop.com/</a> has the following--}}
    {{--                        options in the event there are items that are out of stock--}}
    {{--                        <a href="{{ route('front.developers') }}" class="text-dark">https://imausashop.com/</a> Wait for all items to be--}}
    {{--                        in stock before--}}
    {{--                        dispatching.</p>--}}
    {{--                    <p>7. IMPORT DUTY AND TAXES When dealing with <a href="{{ route('front.developers') }}" class="text-dark">https://imausashop.com/</a>,--}}
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-12">
                    <div class="box-styles">
                        <h4>IMA USA Shop Affiliate Program</h4>
                    ...
                    <div class="box-styles">
                        ...
                        <strong>
                            https://imausashop.com/ is committed to excellence and the full satisfaction of our
                        ...
                        <p>4. LOST/STOLEN PACKAGES https://imausashop.com/ is not responsible for lost or stolen
                            ...
                            address and you have not received it, please report it to the local authorities.</p>
                        ...
                        <p>
                            7. IMPORT DUTY AND TAXES When dealing with https://imausashop.com/, you have the following
                        ...
                        <p>8. ACCEPTANCE By accessing our site and placing an order, you have willingly accepted the
                            terms of this Shipping Policy.</p>
