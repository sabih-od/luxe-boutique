					...
					background-repeat:none;">
											...
											">
                                                                    ...
                                                                    <tr>
																		...
																		display:table;">
                                                                                        <img
                                                                                            src="{{ asset('assets/images/ima.png') }}"
			...
			border-radius:0px;" bgcolor="#144796">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											line-height:0pt; text-align:left;"><a
                                                                    href="https://twitter.com/OfficeTaskForce"
                                                                    target="_blank"><img
                                                            ...
                                                            <td class="img" width="55" style="font-size:0pt;
											line-height:0pt; text-align:left;"><a
                                                                    href="https://www.linkedin.com/company/ima-usa-shop"
                                                                    target="_blank"><img
                                                                        src="{{ asset('assets/images/linkedin.png') }}"
                                                                        width="20"
                                                            ...
                                                            <td class="img" width="55" style="font-size:0pt;
											line-height:0pt; text-align:left;"><a
                                                                    href="https://www.instagram.com/imausashop"
                                                                    target="_blank"><img
											...
											line-height:0pt; text-align:left;"><a
                                                                    href="https://www.tiktok.com/@imausashop1"
                                                                    target="_blank"><img
                                                                        src="{{ asset('assets/images/tiktok.avif') }}"
                                                                        width="20"
                                                                        height="20" editable="true" border="0"
                                                                        alt=""></a>
                                                            </td>
