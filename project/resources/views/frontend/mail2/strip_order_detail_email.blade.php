...
{{--                                                                                        </multiline>--}}
																		...
																		">
                                                                                        <multiline>
                                                                                            <br>
                                                                                            "Hello {{$vendor_name}},<br>You just received a new order.
                                                                                            <br>Order Number is {{$order_number}}
                                                                                            <br>Here are the order details:<br>
                                                                                            Order quantity: {{$Order_quantity}}<br>
                                                                                            Order price: {{$Order_price}}<br>
                                                                                            Order discount: {{$Order_discount}}<br>
                                                                                            <br>
                                                                                        </multiline>
                                                                                    </td>
                                                                                </tr>
