...
@section('content')
    ...
    <div class="full-row bg-light overlay-dark py-5"
        ...
        <div class="container">
            <div class="row text-center text-white">
                <div class="col-12">
                    <h3 class="mb-2 text-white">{{ __('News') }}</h3>
                </div>
                <div class="col-12">
    ...
    {{--                    <p><a href="{{ route('front.news') }}" class="text-dark">https://imausashop.com/</a> is--}}
    {{--                        committed to excellence and the full--}}
    {{--                        satisfaction of our customers. <a href="{{ route('front.news') }}" class="text-dark">https://imausashop.com/</a>--}}
    {{--                        proudly offers--}}
    ...
    {{--                        <a href="{{ route('front.news') }}" class="text-dark">https://imausashop.com/</a> also--}}
    {{--                        offers same-day dispatch.</p>--}}
    ...
    {{--                    <p>4. LOST/STOLEN PACKAGES <a href="{{ route('front.news') }}" class="text-dark">https://imausashop.com/</a>--}}
    ...
    {{--                    <p>5. RETURN REQUEST DAYS <a href="{{ route('front.news') }}" class="text-dark">https://imausashop.com/</a>--}}
    ...
    {{--                    <p>6. OUT OF STOCK ITEM PROCESS <a href="{{ route('front.news') }}" class="text-dark">https://imausashop.com/</a>--}}
    {{--                        has the following--}}
    {{--                        options in the event there are items that are out of stock--}}
    {{--                        <a href="{{ route('front.news') }}" class="text-dark">https://imausashop.com/</a> Wait--}}
    {{--                        for all items to be in stock before--}}
    {{--                        dispatching.</p>--}}
    {{--                    <p>7. IMPORT DUTY AND TAXES When dealing with <a href="{{ route('front.news') }}" class="text-dark">https://imausashop.com/</a>,--}}
