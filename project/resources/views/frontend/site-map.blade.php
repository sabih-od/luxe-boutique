...
@section('content')
    ...
    <div class="full-row bg-light overlay-dark py-5"
        ...
        <div class="container">
            <div class="row text-center text-white">
                <div class="col-12">
                    <h3 class="mb-2 text-white">{{ __('Site map') }}</h3>
                </div>
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 d-inline-flex bg-transparent p-0">
                            <li class="breadcrumb-item"><a href="{{ route('front.index') }}">{{ __('Home') }}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Site map') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    {{--                        suspended from our site and would not be able to operate anymore.</p>--}}
    ...
    {{--                    <p><a href="{{ route('front.siteMap') }}" class="text-dark">https://imausashop.com/</a> is committed to excellence and--}}
    {{--                        the full satisfaction of our customers. <a--}}
    {{--                            href="{{ route('front.siteMap') }}" class="text-dark">https://imausashop.com/</a> proudly offers shipping--}}
    {{--                        services. Be assured we are doing everything in our power to get your order to you as soon as--}}
    {{--                        possible. Please consider any holidays that might impact delivery times.--}}
    {{--                        <a href="{{ route('front.siteMap') }}" class="text-dark">https://imausashop.com/</a> also offers same-day--}}
    {{--                        dispatch.</p>--}}
    ...
    {{--                    <p>4. LOST/STOLEN PACKAGES <a href="{{ route('front.siteMap') }}" class="text-dark">https://imausashop.com/</a> is not--}}
    {{--                        responsible for lost or stolen packages. If your tracking information states that your package--}}
    {{--                        was delivered to your address and you have not received it, please report it to the local--}}
    {{--                        authorities.</p>--}}
    {{--                    <p>5. RETURN REQUEST DAYS <a href="{{ route('front.siteMap') }}" class="text-dark">https://imausashop.com/</a> allows--}}
    {{--                        you to return its item (s) within a period of 7 days. Kindly be advised that the item (s) should--}}
    {{--                        be returned unopened and unused.</p>--}}
    {{--                    <p>6. OUT OF STOCK ITEM PROCESS <a href="{{ route('front.siteMap') }}" class="text-dark">https://imausashop.com/</a>--}}
    {{--                        has the following options in the event there are items that are out of stock--}}
    {{--                        <a href="{{ route('front.siteMap') }}" class="text-dark">https://imausashop.com/</a> Wait for all items to be in--}}
    {{--                        stock before dispatching.</p>--}}
    {{--                    <p>7. IMPORT DUTY AND TAXES When dealing with <a href="{{ route('front.siteMap') }}" class="text-dark">https://imausashop.com/</a>--}}
    ...
    {{--                    <p>8. ACCEPTANCE By accessing our site and placing an order, you have willingly accepted the terms--}}
    {{--                        of this Shipping Policy.</p>--}}
    {{--                    <p>9. CONTACT INFORMATION In the event you have any questions or comments, please reach us via the--}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-3 col-12">
                    <div class="detail-box">
                        <img src="{{asset('assets/images/iconic05.png')}}" alt="">
                        <h4>IMA USA Shop Policies <br>
                            And Regulations</h4>
                ...
                <div class="col-lg-3 col-sm-3 col-12">
                    <div class="detail-box">
                        <img src="{{asset('assets/images/iconic04.png')}}" alt="">
                        <h4>Prohibit From Selling <br>
                            Restricted Items</h4>
                        <p>At IMA USA Shop, we don’t allow the buying and selling of rated-x products, drugs, and other
                            inappropriate products. Any seller that will be found while exchanging any such item would
                            be suspended from our site and would not be able to operate anymore.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3 col-12">
                    <div class="detail-box">
                        <img src="{{asset('assets/images/iconic06.png')}}" alt="">
                ...
                <div class="col-lg-3 col-sm-3 col-12">
                    <div class="detail-box">
                        <img src="{{asset('assets/images/iconic07.png')}}" alt="">
                        <h4>Money-Back Policy</h4>
                        <p>
                            Our selling policies include the guarantee of refunding the money in case of any mishap;
                            however, IMA USA Shop reserves all the right to disclaim the money-back policy if the issues
                            are found inconsiderable.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-12">
                    <div class="box-styles mt-5">
                        <h4>Shipping Policy</h4>
                        <strong>https://imausashop.com/ is committed to excellence and the full satisfaction of our
                        ...
                        <p>4. LOST/STOLEN PACKAGES https://imausashop.com/ is not responsible for lost or stolen
