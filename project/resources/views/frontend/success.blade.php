                                                                ...
                                                                <div class="billing-add-area">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <p>{{ __('Paid Amount:') }}
                                                                                {{ \PriceHelper::showCurrencyPrice($product['price'] * $order->currency_value + \Session::get('shipping_rate') + \Session::get('packing_cost'))  }}
                                                                            </p>
                                                                            @endforeach
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    @foreach($tempcart->items as $product)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ \PriceHelper::showCurrencyPrice((\Session::get('shipping_rate')) * $order->currency_value) }}
                                                                            </td>

                                                                            <td>{{ \PriceHelper::showCurrencyPrice((\Session::get('packing_cost')) * $order->currency_value) }}
                                                                            </td>

                                                                            <td>{{ \PriceHelper::showCurrencyPrice($product['price'] * $order->currency_value + \Session::get('shipping_rate') + \Session::get('packing_cost'))  }}
