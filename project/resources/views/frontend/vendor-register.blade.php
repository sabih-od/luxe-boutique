                                    ...
                                    <div class="registration-form border">
                                        ...
                                        <form id="registerform" action="{{route('user-register-submit')}}" method="POST">
                                           ...
                                           {{-- <p>
                                            ...
                                            <p>
                                                <input type="text" name="shop_address" class="form-control"  placeholder="{{ __('Shop Address') }}" >
                                            </p>
                                            ...
                                            <p>
                                                <input type="text" name="shop_message" class="form-control"  placeholder="{{ __('Leave your message for Admin') }}" >
                                            </p>
