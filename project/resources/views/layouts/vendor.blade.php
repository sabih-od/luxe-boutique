                        ...
                        <ul class="list">
                            ...
                            <li class="bell-area">
                                <a id="notf_order" class="dropdown-toggle-1" href="javascript:;">
                                    ...
                                    <span
                                        id="order-notf-count">{{ App\Models\UserNotification::countOrder(Auth::user()->id) }}</span>
                                </a>
                                ...
                                <div class="dropdown-menu">
                                    <div class="dropdownmenu-wrapper">
                                        <ul>
                                            ...
                                            <li>
                                                <a target="_blank"
                                                   href="{{ route('front.vendorshop',str_replace(' ', '-', Auth::user()->shop_name)) }}"><i
                                                        class="fas fa-eye"></i> {{ __('Visit Store') }}</a>
                                            </li>

                                            {{--                                            @dd(\Auth::user()->id)--}}

                                            {{--                                            @if( isset($productt->user_id)  != 0)--}}
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar" class="nav-sidebar">
                <ul class="list-unstyled components" id="accordion">
                    ...
                    <li>
                        <a target="_blank"
                           href="{{ route('front.vendorshop',str_replace(' ', '-', Auth::user()->shop_name)) }}"
                           class="wave-effect"><i class="fas fa-eye mr-2"></i> {{ __('Visit Store') }}</a>
                    </li>

                    {{--                    <li>--}}
                    {{--                        <a href="{{ route('vendor-verify') }}" class="wave-effect"><i--}}
                    {{--                                class="fa fa-home mr-2"></i>{{ __('Verify Vendor') }}</a>--}}
                    {{--                    </li>--}}
                    ...
                    <li>
                        <a href="#order" class="accordion-toggle wave-effect"
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
                            ...
                            {{--                            </li>--}}
                            <li>
                                <a href="{{ route('vendor-report-index') }}"><span>{{ __('Reports') }}</span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('vendor-wt-index') }}" class=" wave-effect"><i
                                class="fas fa-list"></i>{{ __('Withdraws') }}</a>
                    </li>
                    {{--                                                <li>--}}
                    {{--                    								<a href="{{ route('vendor-payment') }}" class=" wave-effect"><i class="fas fa-list"></i>{{ __('Payment Details') }}</a>--}}
                    {{--                    							</li>--}}
                    ...
                    {{--							</li>--}}
                    <li>
                        <a href="{{ route('vendor.income') }}" class="wave-effect"><i
                                class="fas fa-eye mr-2"></i> {{ __('Total Earning') }}</a>
                    </li>
                </ul>
            </nav>
