...
<li>
    <a href="{{ route('admin-order-refund') }}"><i class="fas fa-upload"></i>{{ __('Refund Order') }}</a>
</li>
{{--<li>--}}
...
@endif" id="menu5" data-parent="#accordion">
        <li class="{{ $gs->active_theme == 2 ? 'd-none': '' }} @if(request()->is('admin/attribute/*/manage') && request()->input('type')=='category') active @endif">
        ...
        <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='subcategory') active @endif">
            <a href="{{ route('admin-subcat-index') }}"><span>{{ $gs->active_theme == 2 ? __('Category') : __('Sub Category') }}</span></a>
        </li>
        <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='childcategory') active @endif">
            <a href="{{ route('admin-childcat-index') }}"><span>{{ $gs->active_theme == 2 ? __('Sub Category') : __('Child Category') }}</span></a>
        </li>
    </ul>
</li>
...
<li>
    <a href="{{ route('front.get.printify.products') }}" class=" wave-effect"><i
            class="icofont-cart mr-2"></i>{{ __('Update Dropshipping Products') }}</a>
</li>
...
{{--        <i class="icofont-invisible"></i></i>{{ __('Visitor') }}--}}
{{--    </a>--}}
{{--</li>--}}
...
{{--<li>--}}
{{--    <a href="#mentor1" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">--}}
{{--        <i class="icofont-verification-check"></i>{{ __('Mentor Verifications') }}--}}
{{--    </a>--}}
{{--    <ul class="collapse list-unstyled" id="mentor1" data-parent="#accordion">--}}
{{--        <li>--}}
{{--            <a href="{{ route('admin-mentor-verifications','all') }}"><span>{{ __('All Verifications') }}</span></a>--}}
{{--        </li>--}}
{{--        <li>--}}
{{--            <a href="{{ route('admin-mentor-verifications','pending') }}"><span>{{ __('Pending Verifications') }}</span></a>--}}
{{--        </li>--}}
{{--    </ul>--}}
{{--</li>--}}
...
<li>
    ...
    <ul class="collapse list-unstyled" id="msg" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('admin-user-message') }}"><span>{{ __('User Messages') }}</span></a>
        </li>
    </ul>
</li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('admin-shipping-services') }}"><span>{{ __('Shipping Services') }}</span></a>
        </li>
        <li>
