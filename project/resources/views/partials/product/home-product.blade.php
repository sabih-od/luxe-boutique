    ...
    <div class="product-wrapper">
       <div class="product-image">
          <a href="{{ route('front.product', $prod->slug) }}" class="woocommerce-LoopProduct-link">
            <img class="lazy" data-src="{{ $prod->thumbnail ? asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt="Product Image">
         </a>
...
{{--                 @if( $prod->sale_start_date <= \Carbon\Carbon::now()->format('Y-m-d') && $prod->sale_end_date >= \Carbon\Carbon::now()->format('Y-m-d'))--}}
{{--                     <ins>{{ $prod->showPrice() }} </ins>--}}
{{--                     <del>{{ $prod->showPreviousPrice() }}</del>--}}
{{--                 @else--}}
{{--                     <ins>{{ $prod->showPrice() }} </ins>--}}
