                    ...
                    <div class="product type-product">
                        <div class="product-wrapper">
                            <div class="product-image">
                                ...
                                @if(empty($product->sale_start_date AND $product->sale_end_date ) OR $product->sale_start_date <= \Carbon\Carbon::now()->format('Y-m-d') && $product->sale_end_date >= \Carbon\Carbon::now()->format('Y-m-d') )

                                    {{--                                @if( $product->sale_start_date <= \Carbon\Carbon::now()->format('Y-m-d') && $product->sale_end_date >= \Carbon\Carbon::now()->format('Y-m-d'))--}}
                            ...
                            <div class="product-info">
                                ...
                                <div class="product-price">
                                    <div class="price">
                                        ...
                                        @else
                                            <ins>{{ $product->showPreviousPrice() }}</ins>
                                        @endif
                                    </div>
                                </div>
                    ...
                    <div class="product-wrapper">
                        <div class="product-image">
                            <a href="{{ route('front.product', $product->slug ?? '#') }}"
                               class="woocommerce-LoopProduct-link">
                                <img class="lazy"
                                     data-src="{{ $product->is_printify ? ($product->photo ?? '') : ($product->photo ? asset('assets/images/products/'.$product->photo):asset('assets/images/noimage.png')) }}"
                                     alt="Product Image">
                            </a>
                            @if(empty($product->sale_start_date AND $product->sale_end_date ) OR $product->sale_start_date <= \Carbon\Carbon::now()->format('Y-m-d') && $product->sale_end_date >= \Carbon\Carbon::now()->format('Y-m-d') )
                                    ...
                                    @else
                                        ...
                                        <div class="cart-button buynow">
                                            <a class="button add_to_cart_button add-to-cart-quick" href="javascript:;"
                                               ...
                                               data-bs-original-title="{{ __('Buy Now') }}"></a>
                                        </div>
                                    @endif
                                @endif
                                @if(Auth::check())
