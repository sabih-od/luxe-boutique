                        ...
                        <form id="passwordform" action="{{ route('user.change.password') }}" method="POST">
                            ...
                            <div class="form-input">
                                <input type="password" name="newpass" class="Password"
                                       placeholder="{{ __('New Password') }}" required=""><i
                                    class="icofont-ui-password"></i>
                            </div>

                            <div class="form-input">
                                <input type="password" name="renewpass" class="Password"
                                       placeholder="{{ __('Re-Type New Password') }}" required=""><i
                                    class="icofont-ui-password"></i>
                            </div>
