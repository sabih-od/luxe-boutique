                            ...
                            <div class="widget border-0 p-40 widget_categories bg-light account-info">
                                ...
                                <div class="header-area">
                                    ...
                                    <h4 class="title">
                                        ...
                                        @if($user->id == !empty($conv->sent) ? $conv->sent->id : 0)
{{--                                            {{$conv->recieved->name}}--}}
                                        @else
                                            {{$conv->sent->name ?? ''}}
                                        @endif <a class="mybtn1" href="{{ url()->previous() }}"> <i
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="reply-area">
                                                                    ...
                                                                    <div class="right">
                                                                        @if(!empty($message->conversation->sent) ? $message->conversation->sent->is_provider : '0' == 1 )
                                                                        ...
                                                                        @else
                                                                            <img class="img-circle"
                                                                                 ...
                                                                                 alt="">
                                                                        @endif
{{--                                                                            <form action="{{route('user-message-delete',$message->conversation->id)}}">--}}
{{--                                                                                @csrf--}}
{{--                                                                                @method('DELETE')--}}
{{--                                                                                <button class="btn btn-danger" type="submit">Delete</button>--}}
{{--                                                                            </form>--}}
                                                                        <p class="ticket-date">{{ $message->sentUser->name ?? '' }}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <form id="messageform"
                                            ...
                                            <div class="panel-footer">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="sent_user"
                                                           value="{{$conv->sent_user}}">
...
{{--                                                               value="{{$conv->sent->id ?? ''}}">--}}
                                                        ...
                                                        <input type="hidden "name="recieved_user"
                                                               value="{{$conv->recieved_user}}"style="display: none;">
                                                    @endif
                                ...
                                <div class="col-md-12">
                                    <div class="contact-form">
                                        <form id="emailreply1">
                                            ...
                                            <ul>
                                                <li>
                                                    <input type="text" class="input-field form-control border mb-4"
                                                           id="order" name="order_numkber"
                                                           placeholder="{{ __('Order Number *') }}" required="">
                                                </li>

                                                <li>
                                                    <input type="text" class="input-field form-control border mb-4"
                                                           id="subj1" name="subject" placeholder="{{ __('Subject *') }}"
                                                           required="">
                                                </li>
                                                <li>
                                                    <textarea class="input-field textarea form-control border mb-4"
                                                              name="message" id="msg1"
