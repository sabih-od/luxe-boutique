                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ $gs->active_theme == 2 ? __('Product Type') : __('Category') }}*</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <select id="cat" name="category_id" required="">
                                                    <option value="">{{ $gs->active_theme == 2 ? __('Select Product Type') : __('Select Category') }}</option>
                                                    @foreach($cats as $cat)
                                                        @if($gs->active_theme == 1)
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ $gs->active_theme == 2 ? __('Category') : __('Sub Category') }}</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <select id="subcat" name="subcategory_id" disabled="">
                                                    <option value="">{{ $gs->active_theme == 2 ? __('Select Category') :  __('Select Sub Category') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ $gs->active_theme == 2 ? __('Sub Category') :__('Child Category') }}</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <select id="childcat" name="childcategory_id" disabled="">
                                                    <option value="">{{ $gs->active_theme == 2 ? __('Select Sub Category') :__('Select Child Category') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" id="default_stock">
                                            {{--<div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __('Age') }}*</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="age[]" class="age" type="checkbox"
                                                       id="age-0-3" value="0-3" {{ str_contains(json_encode($data->age), '0-3') ? 'checked' : '' }}>
                                                <label for="age-0-3">0 - 3</label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="age[]" class="age" type="checkbox"
                                                       id="age-preschool" value="preschool" {{ str_contains(json_encode($data->age), 'preschool') ? 'checked' : '' }}>
                                                <label for="age-preschool">Preschool</label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="age[]" class="age" type="checkbox"
                                                       id="age-elementary" value="elementary" {{ str_contains(json_encode($data->age), 'elementary') ? 'checked' : '' }}>
                                                <label for="age-elementary">Elementary</label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="age[]" class="age" type="checkbox"
                                                       id="age-middle" value="middle" {{ str_contains(json_encode($data->age), 'middle') ? 'checked' : '' }}>
                                                <label for="age-middle">Middle</label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="age[]" class="age" type="checkbox"
                                                       id="age-high-school" value="high-school" {{ str_contains(json_encode($data->age), 'high-school') ? 'checked' : '' }}>
                                                <label for="age-high-school">High School</label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="age[]" class="age" type="checkbox"
                                                       id="age-adult" value="adult" {{ str_contains(json_encode($data->age), 'adult') ? 'checked' : '' }}>
                                                <label for="age-adult">Adult</label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input name="age[]" class="age" type="checkbox"
                                                       id="age-all-ages" value="all-ages" {{ str_contains(json_encode($data->age), 'all-ages') ? 'checked' : '' }}>
