...
{{--                                        </div>--}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <select id="cat" name="category_id" required="">
                                                    ...
                                                    @foreach($cats as $cat)
                                                        @if($gs->active_theme == 2 && $cat->slug == 'virtual-items')
                                                            <option
                                        ...
                                        {{--                                                    <option--}}
                                        {{--                                                        value="1" {{ $data->file != null ? 'selected':'' }}>{{ __("Upload By File") }}</option>--}}
                                        {{--                                                    <option--}}
                                        {{--                                                        value="2" {{ $data->link != null ? 'selected':'' }}>{{ __("Upload By Link") }}</option>--}}
                                        {{--                                                </select>--}}
                                        {{--                                            </div>--}}
                                        {{--                                        </div>--}}
                                        ...
                                        <div class="row file {{ $data->file != null ? '':'hidden' }}">
                                            <div class="col-lg-12">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __("Preview File") }}*</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <a href="{{ asset('assets/files') . '/' . $data->file }}"
                                                   class="btn btn-success">Preview File</a>
                                            </div>
                                        </div>
