                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <select id="cat" name="category_id" required="">
                                                    <option>{{ $gs->active_theme == 2 ? __('Select Product Type') : __('Select Category') }}</option>
                                                    @foreach($cats as $cat)
                                                        <option
                                                ...
                                                <select id="subcat" name="subcategory_id">
                                                    ...
                                                    @if($data->subcategory_id == null)
                                                        @foreach($data->category->subs as $sub)
                                                            <option
                                                                data-href="{{ route('vendor-childcat-load',$sub->id) }}"
                                                ...
                                                <ul class="list">
                                                    <li>
                                                        <input class="checkclick1" name="product_brand_check"
                                                               type="checkbox" id="product_brand_check"
                                                               value="1" {{ $data->product_brand != 0 ? "checked":"" }}>
                                                        <label
                                                            for="product_brand_check">{{ __('Product Brand') }}</label>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>

                                        <div class="{{ $data->product_brand != null ? "" : "showbox" }}">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="left-area">
                                                ...
                                                <div class="col-lg-12">
                                                    <input type="text" class="input-field"
                                                           ...
                                                           name="product_brand" value="{{ $data->product_brand }}">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <ul class="list">
                                                    <li>
                                                        <input class="checkclicks" name="size_check" type="checkbox"
                                                               id="tcheck" value="1" {{ !empty($data->size) ? "checked":"" }}>
                                                ...
                                                <ul class="list">
                                                    <li>
                                                        ...
                                                        <label for="size-check"
                                                               class="stock-text">{{ __('Manage Variations') }}</label>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
{{--                                                       id="age-0-3"--}}
{{--                                                       value="0-3" {{ str_contains(json_encode($data->age), '0-3') ? 'checked' : '' }}>--}}
{{--                                                <label for="age-0-3">0 - 3</label>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-lg-12">--}}
{{--                                                <input name="age[]" class="age" type="checkbox"--}}
{{--                                                       id="age-preschool"--}}
{{--                                                       value="preschool" {{ str_contains(json_encode($data->age), 'preschool') ? 'checked' : '' }}>--}}
{{--                                                <label for="age-preschool">Preschool</label>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-lg-12">--}}
{{--                                                <input name="age[]" class="age" type="checkbox"--}}
{{--                                                       id="age-elementary"--}}
{{--                                                       value="elementary" {{ str_contains(json_encode($data->age), 'elementary') ? 'checked' : '' }}>--}}
{{--                                                <label for="age-elementary">Elementary</label>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-lg-12">--}}
{{--                                                <input name="age[]" class="age" type="checkbox"--}}
{{--                                                       id="age-middle"--}}
{{--                                                       value="middle" {{ str_contains(json_encode($data->age), 'middle') ? 'checked' : '' }}>--}}
{{--                                                <label for="age-middle">Middle</label>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-lg-12">--}}
{{--                                                <input name="age[]" class="age" type="checkbox"--}}
{{--                                                       id="age-high-school"--}}
{{--                                                       value="high-school" {{ str_contains(json_encode($data->age), 'high-school') ? 'checked' : '' }}>--}}
{{--                                                <label for="age-high-school">High School</label>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-lg-12">--}}
{{--                                                <input name="age[]" class="age" type="checkbox"--}}
{{--                                                       id="age-adult"--}}
{{--                                                       value="adult" {{ str_contains(json_encode($data->age), 'adult') ? 'checked' : '' }}>--}}
{{--                                                <label for="age-adult">Adult</label>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-lg-12">--}}
{{--                                                <input name="age[]" class="age" type="checkbox"--}}
{{--                                                       id="age-all-ages"--}}
{{--                                                       value="all-ages" {{ str_contains(json_encode($data->age), 'all-ages') ? 'checked' : '' }}>--}}
