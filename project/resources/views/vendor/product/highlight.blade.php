...
<link href="{{asset('assets/vendorr/css/jquery-ui.css')}}" rel="stylesheet" type="text/css">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{route('vendor-prod-feature',$data->id)}}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
