                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('vendor-profile-update') }}" method="POST"
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="right-area">
                                            @if($data->shop_name)
                                                <h6 class="heading"> {{ $data->shop_name }}</h6>
                                            @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="shop_number"
                                               ...
                                               value="{{$data->shop_number}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" name="shop_address"
                                               placeholder="{{ __('Shop Address') }}" value="{{$data->shop_address}}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea class="input-field nic-edit" name="shop_details"
                                                  placeholder="{{ __('Shop Details') }}">{{$data->shop_details}}</textarea>
                                    </div>
                                </div>
