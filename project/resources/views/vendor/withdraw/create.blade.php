                            ...
                            <form id="geniusform" class="form-horizontal" action="{{route('vendor-wt-store')}}"
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-sm-4" for="name"><b>{{ __('Current Balance') }} :
                                            {{ App\Models\Product::vendorConvertPrice((Auth::user()->current_balance - $last30DaysEarning) > 0 ? Auth::user()->current_balance - $last30DaysEarning : 0) }}</b></label>
                                </div>
                                ...
                                <div id="stripe" style="display: none;">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-sm-12" for="name">{{ __('Account Id') }} *
                                        </label>
                                        <div class="col-sm-12">
                                            <input name="acc_id" placeholder="{{ __('Stripe Account ID') }}"
                                                   class="form-control"
                                                   value="{{ !is_null(Auth::user()->stripe_account_id) ? Auth::user()->stripe_account_id : 'Please Connect Your Account To Withdraw The Payment' }}"
                                                   type="text" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="add-product-footer">
                                    <button name="addProduct_btn" type="submit"
                                            class="mybtn1">{{ !is_null(Auth::user()->stripe_account_id) ? __('Withdraw') : __('Please Connect Stripe') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
