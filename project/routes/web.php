<?php
//----------Luxe_Boutique -----------
Route::get('/about',[\App\Http\Controllers\LuxeFront\LuxeController::class,'about'])->name('front.about');
Route::get('/contactUs',[\App\Http\Controllers\LuxeFront\LuxeController::class,'contact'])->name('front.contactUs');
Route::get('/shop',[\App\Http\Controllers\LuxeFront\LuxeController::class,'shop'])->name('front.shop');
Route::get('/category/{id}',[\App\Http\Controllers\LuxeFront\LuxeController::class,'categories'])->name('front.categories');
...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:orders'], function () {
        ...
        // Order Tracking
//
//        Route::get('/orderRefund/datatables', 'User\OrderController@datatables')->name('admin-order-datatables');

//        Order Refund
        Route::get('/orders/datatables', 'Admin\OrderController@refunddatatables')->name('admin-orderrefund-datatables'); //JSON REQUEST
        Route::get('/order/refund', 'Admin\OrderController@RefundOrdershow')->name('admin-order-refund');
//        Route::get('/order/refund/edit/{id}', 'Admin\OrderController@OrderRefundEdit')->name('admin-order-refund-edit');
        Route::post('/order/refund/edit', 'Admin\OrderController@OrderRefundEdit')->name('admin-order-refund-edit');
        Route::post('/order/refund/update', 'Admin\OrderController@OrderRefundUpdate')->name('admin-order-refund-update');
...
/////////////////////////////// ////////////////////////////////////////////
    ...
    //-------------START ADMIN SUBSCRIPTION COUPON CODE SETTING-------
//    Route::get('/pkg/coupon/datatables', 'Admin\CouponController@pkgcdatatables')->name('admin-pkg-coupon-datatables'); //JSON REQUEST
//    Route::get('/pkg/coupon', 'Admin\CouponController@pkgcindex')->name('admin-coupon-index');
//    Route::get('/pkg/coupon/create', 'Admin\CouponController@pkgcouponcreate')->name('admin-pkg-coupon-create');
//    Route::post('/pkg/coupon/create', 'Admin\CouponController@pkgcouponstore')->name('admin-pkg-coupon-store');
//    Route::get('/pkg/coupon/edit/{id}', 'Admin\CouponController@pkgcouponedit')->name('admin-pkg-coupon-edit');
//    Route::post('/pkg/coupon/edit/{id}', 'Admin\CouponController@pkgcouponupdate')->name('admin-pkg-coupon-update');
//    Route::delete('/pkg/coupon/delete/{id}', 'Admin\CouponController@pkgcoupondestroy')->name('admin-pkg-coupon-delete');
//    Route::get('/pkg/coupon/status/{id1}/{id2}', 'Admin\CouponController@pkgcouponstatus')->name('admin-pkg-coupon-status');
    //-------------END ADMIN SUBSCRIPTION COUPON CODE SETTING-------

    //------------ ADMIN USER SECTION ------------

    Route::group(['middleware' => 'permissions:customers'], function () {

        Route::get('/visitors/datatables', 'Admin\VisitorController@datatables')->name('admin-visitors-datatables'); //JSON REQUEST
        Route::get('/visitors', 'Admin\VisitorController@visitor')->name('admin-visitor-index');
        ...
        Route::post('/user/vendor', 'Admin\UserController@admin_sent_to_email_vendor')->name('admin_sent_to_email_vendor');
    ...
    Route::group(['middleware' => 'permissions:vendors'], function () {
        ...
        Route::get('/vendors/show/{id}', 'Admin\VendorController@show')->name('admin-vendor-show');
        ...
        Route::get('/vendor/package/{id}', 'Admin\VendorController@package')->name('admin-vendor-package');
    ...
    //------------ ADMIN MENTOR VERIFICATION SECTION ------------

    Route::group(['middleware' => 'permissions:mentor_verifications'], function () {
        Route::get('/mentor/verifications/{slug}', 'Admin\MentorController@verifications')->name('admin-mentor-verifications');
        Route::get('/mentor/verifications/datatables/{status}', 'Admin\MentorController@dataTables')->name('admin-mentor-datatables');
        Route::get('/mentor/verifications/status/{user_id}/{status}', 'Admin\MentorController@status')->name('admin-mentor-status');
        Route::get('/mentor/verifications/show/attachment', 'Admin\MentorController@show')->name('admin-mentor-show');
        Route::delete('/mentor/verifications/delete/{id}', 'Admin\MentorController@destroy')->name('admin-mentor-delete');
    });

    //------------ ADMIN MENTOR VERIFICATION SECTION ENDS ------------
    ...
    Route::group(['middleware' => 'permissions:messages'], function () {
        ...
        Route::get('/user/message/datatable', 'Admin\MessageController@userMessageDatatable')->name('admin-user-message-datatable');
        Route::get('/user/message', 'Admin\MessageController@userMessage')->name('admin-user-message');
        ...
        Route::delete('/user/message/delete/{id}', 'Admin\MessageController@userMessageDelete')->name('admin-user-message-delete');
        Route::post('/user/send/message', 'Admin\MessageController@usercontact')->name('admin-send-message');
        Route::post('/user/send/message', 'Admin\MessageController@Messagedetail')->name('Messagedetail');
...
// Deal Of The Day
        ...
        /*  Shipping Services   */
        Route::match(['get', 'post'], 'shipping-services', 'Admin\ShippingServiceController@index')->name('admin-shipping-services');
...
// ************************************ VENDOR SECTION **********************************************
    ...
    Route::prefix('vendor')->group(function () {
        ...
        Route::group(['middleware' => 'vendor'], function () {
            ...
            Route::get('/dashboard', 'Vendor\VendorController@index')->name('vendor.dashboard')->middleware('issubscriptionexipre');
            ...
            //----------- Merchandise Request -----------
            Route::get('/merchandise-order-request/datatables', 'Vendor\OrderController@merchandiseOrderRequestDatatables')->name('vendor-merchandise-request-datatables');
            Route::get('/merchandise-order-request/{id}/show', 'Vendor\OrderController@merchandiseOrderRequestShow')->name('vendor-merchandise-order-request-show');
            Route::get('/merchandise-order-request', 'Vendor\OrderController@merchandiseOrderRequest')->name('vendor.merchandise.request');
            //--------- Merchandise Request Ends --------
            ...
            Route::get('/reports/datatables', 'Vendor\ReportController@datatables')->name('vendor-report-datatables'); //JSON REQUEST
            Route::get('/reports', 'Vendor\ReportController@index')->name('vendor-report-index');
            Route::delete('/reports/delete/{id}', 'Vendor\ReportController@destroy')->name('vendor-report-delete');
            Route::get('/reports/show/{id}', 'Vendor\ReportController@show')->name('vendor-report-show');
            ...
            // FEATURE SECTION
            Route::get('/products/feature/{id}', 'Vendor\ProductController@feature')->name('vendor-prod-feature');
            Route::post('/products/feature/{id}', 'Vendor\ProductController@featuresubmit')->name('vendor-prod-feature');
            // FEATURE SECTION ENDS
            ...
            // Stripe Connect
            Route::get('stripe/connect/{status}', 'Vendor\WithdrawController@connectStripe')->name('vendor-connect-stripe');

            //  Vendor Payment Details
            Route::get('/payment-details', 'Vendor\PaymentController@index')->name('vendor-payment');
            Route::post('/payment-details/create', 'Vendor\PaymentController@store')->name('vendor-payment-store');
...
// ************************************ USER SECTION **********************************************
    ...
    Route::prefix('user')->group(function () {
        ...
        // USER AUTH SECION
        Route::get('/login', 'User\LoginController@showLoginForm')->name('user.login')->withoutMiddleware(['verify.csrf.token']);
        ...
        // User Login
        Route::post('/login', 'Auth\User\LoginController@login')->name('user.login.submit')->withoutMiddleware(['verify.csrf.token']);
        // User Login End

        // User Register
        Route::post('/register', 'Auth\User\RegisterController@register')->name('user-register-submit');
        Route::post('/register/verify', 'Auth\User\RegisterController@verification')->name('user-register-verification');
        // User Register End
        ...
        // Mentor
        Route::match(['get', 'post'], '/become-a-mentor', 'User\UserController@becomeAMentor')->name('user-become-a-mentor');
        Route::match(['get'], 'mentor-sessions', 'User\UserController@MentorSession')->name('user-mentor-sessions');
        Route::match(['get'], 'mentor-sessions-datatable', 'User\UserController@MentorSessionDataTable')->name('user-mentor-sessions-datatables');

        // User Reset
        Route::get('/reset', 'User\UserController@resetform')->name('user-reset')->middleware('issubscriptionexipre');
        Route::post('/reset', 'User\UserController@reset')->name('user-reset-submit');
        // User Reset End

        // User Profile
        Route::get('/profile', 'User\UserController@profile')->name('user-profile')->middleware('issubscriptionexipre');
        ...
        Route::get('/state/wise/city/{state_id}', 'Front\CheckoutController@getCity')->name('country.wise.city');
        ...
        Route::get('/orders', 'User\OrderController@orders')->name('user-orders')->middleware('issubscriptionexipre');
        ...
        Route::post('/orderRefund', 'User\OrderController@orderRefund')->name('orderRefund');
        ...
        Route::post('/check-coupon-code','User\SubscriptionController@check_coupon_code')->name('check-coupon-code');
        Route::get('/currentpkg/{id}', 'User\SubscriptionController@uservendorcurrentpkg')->name('user-vendor-currentpkg');
        ...
        Route::get('/payment/return', 'User\SubscriptionController@payreturn')->name('user.payment.return.get');
        Route::post('/payment/return', 'User\SubscriptionController@payreturn')->name('user.payment.return');
        ...
        Route::get('/deposit/transactions', 'User\DepositController@transactions')->name('user-transactions-index')->middleware('issubscriptionexipre');;
        ...
        Route::get('/messages', 'User\MessageController@messages')->name('user-messages')->middleware('issubscriptionexipre');
        ...
        Route::post('/message/delete', 'User\MessageController@messagedelete')->name('user-message-delete');
        ...
        // Tickets
        Route::get('admin/tickets', 'User\MessageController@adminmessages')->name('user-message-index')->middleware('issubscriptionexipre');
        // Disputes
        Route::get('admin/disputes', 'User\MessageController@adminDiscordmessages')->name('user-dmessage-index')->middleware('issubscriptionexipre');
    ...
    Route::post('/user-booking', 'Front\FrontendController@userBookings')->name('front.userBookings');
    Route::get('/', 'Front\FrontendController@index')->name('front.index');
    Route::group(['middleware' => 'restrict.front'], function () {
    });
    ...
    Route::group(['middleware' => 'restrict.front'], function () {
        ...
        // Restrict Front Pages
        Route::post('/item/report', 'Front\CatalogController@report')->name('product.report');

        Route::get('training', 'Front\FrontendController@training')->name('front.training');
        Route::get('slp-mentors', 'Front\FrontendController@slpMentors')->name('front.slpMentors');
        Route::get('slp-mentors-datatable', 'Front\FrontendController@slpMentorsDataTable')->name('front.slpMentorsDataTable');
        Route::post('submit-mentor-session', 'Front\FrontendController@createMentorSession')->name('submit-mentor-session-form');
        Route::get('merchandise', 'Front\FrontendController@merchandise')->name('front.merchandise');
        Route::get('membership', 'Front\FrontendController@membership')->name('front.membership');
        // Route::get('forums', 'Front\FrontendController@forums')->name('front.forums');
...
//        Route::get('/category/{category?}/{subcategory?}/{childcategory?}/{id?}', 'Front\CatalogController@category')->name('front.category');
//        Route::get('/autocomplete', 'Front\CatalogController@search')->name('front.autocomplete.search');
...
//        Route::get('/categories', 'Front\CatalogController@categories')->name('front.categories');
        ...
        Route::get('/real-item-marketplace', 'Front\CatalogController@categories')->name('front.real-item-marketplace');
//        Route::get('/shop', 'Front\CatalogController@categories')->name('front.shop');

        // Printify
        Route::get('printify', 'Front\PrintifyController@getAllProducts')->name('front.get.printify.products');
        Route::get('printify-product-details/{id}', 'Front\PrintifyController@p')->name('front.printify.product.details');
        // Printify
        Route::get('printify', 'Front\PrintifyController@getAllProducts')->name('front.get.printify.products');
        Route::get('printify-product-details/{id}', 'Front\PrintifyController@productDetails')->name('front.printify.product.details');
        ...
        // MERCHANDISE REQUEST SUBMISSION
        Route::post('merchandise-request-form/{id}', 'Front\ProductDetailsController@merchandiseProductForm')->name('front.merchandise.request');
        ...
        Route::get('calculate-usps-shipping', 'USPSController@index')->name('calculate.usps.shipping');
        ...
        Route::get('visit/store/{slug}', 'Front\VendorController@vendorshop')->name('front.vendorshop');

        Route::get('/{slug}/real-item-products', 'Front\VendorController@realItemProducts')->name('front.vendor.product');
        Route::get('/{slug}/virtual-products', 'Front\VendorController@virtualProducts')->name('front.vendor.virtual.product');
